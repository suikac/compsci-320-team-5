...
import LoginSuccessedPopUp from "./sub-components/LoginSuccessedPopUp";
import LoginFailedPopUp from "./sub-components/LoginFailedPopUp";
        ...
        return (
            <div class = "container">
                <form onSubmit= {this.submit_credentials}>
                    ...
                    <LoginFailedPopUp trigger = {this.state.failed} exist = {() => this.setState({
                    fail: false})}>
                    </LoginFailedPopUp>
